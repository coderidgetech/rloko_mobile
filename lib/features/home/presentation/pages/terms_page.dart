...
class TermsPage extends StatelessWidget {
  ...
  static const _sections = [
    ('Acceptance of terms', 'By accessing or using Rloko\'s website and mobile app, you agree to be bound by these Terms of Service. If you do not agree, please do not use our services.'),
    ('Use of service', 'You must use our platform only for lawful purposes. You may not misuse the service, attempt to gain unauthorized access, or use it in any way that could harm Rloko or other users.'),
    ...
    ('Intellectual property', 'All content on Rloko—including logos, text, images, and software—is owned by Rloko or its licensors and is protected by copyright and other laws. You may not copy or use it without permission.'),
