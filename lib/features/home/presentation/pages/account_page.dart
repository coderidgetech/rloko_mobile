    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _MenuButton(icon: Icons.card_giftcard_outlined, label: 'Rloco Rewards', highlight: true, onTap: () => context.push('/rewards')),
          ...
          _MenuButton(icon: Icons.info_outline, label: 'About Rloco', onTap: () => context.push('/about')),
